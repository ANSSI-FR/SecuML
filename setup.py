...
setup(
        ...
        package_dir = {'SecuML_core': 'SecuML/core',
                       'SecuML_experiments': 'SecuML/experiments',
                       'SecuML_web': 'SecuML/web'},
        packages = find_packages(),
        include_package_data = True,
        install_requires = requires,
        dependency_links=['git+https://github.com/ab-anssi/metric-learn.git@v0.4.0#egg=metric-learn-0.4.0'],
        scripts = [
            'scripts/SecuML_ILAB',
            'scripts/SecuML_DIADEM',
            'scripts/SecuML_clustering',
            'scripts/SecuML_descriptive_statistics',
            'scripts/SecuML_feature_selection',
