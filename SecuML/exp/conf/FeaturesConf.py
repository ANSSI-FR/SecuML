...
class FeaturesConf(Conf):
    ...
    def generateParser(parser, filters=True):
        ...
        group.add_argument('--features', '-f', dest='input_features',
        ...
        if filters:
            ...
            filter_group.add_argument('--filter-in', required=False,
                             default=None,
                             help='File containing the features to use. '
                                  'File format: one feature id per line. ')
            filter_group.add_argument('--filter-out', required=False,
                             default=None,
