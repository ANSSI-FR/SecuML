...
from .postgresql_specific import annotationsWithFamilies
...
def loadGroundTruth(cursor, filename, dataset_id):
    families = annotationsWithFamilies(filename)
...
def loadPartialAnnotations(cursor, filename, annotations_id, dataset_id):
    families = annotationsWithFamilies(filename)
