...
class RareCategoryDetectionConf(ExpConf):
    ...
    def fromArgs(args):
        ...
        annotations_conf = AnnotationsConf(args.annotations_file, None,
                                           secuml_conf.logger)
        factory = ActiveLearningConfFactory.getFactory()
        core_conf = factory.fromArgs('RareCategoryDetection', args,
                                     secuml_conf.logger)
        return RareCategoryDetectionConf(secuml_conf, dataset_conf,
    ...
    def from_json(conf_json, secuml_conf):
        ...
        core_conf = factory.from_json(conf_json['core_conf'],
                                      secuml_conf.logger)
        conf = RareCategoryDetectionConf(secuml_conf,
                                   dataset_conf,
                                   features_conf,
                                   annotations_conf,
                                   core_conf,
