...
from SecuML.core.active_learning.strategies.CesaBianchi import CesaBianchi

from . import ActiveLearningStrategyFactoryExp
from .queries.CesaBianchiQueriesExp import CesaBianchiQueriesExp
...
class CesaBianchiExp(CesaBianchi):
    ...
    def setQueries(self):
        ...
        self.annotations = CesaBianchiQueriesExp(self.iteration, b,
                                                 num_annotations)
