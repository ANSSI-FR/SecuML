...
from SecuML.core.active_learning.strategies.queries.UncertainQueries import UncertainQueries

from SecuML.exp.active_learning.strategies.queries.QueryExp import QueryExp


class UncertainQueriesExp(UncertainQueries):

    def generateQuery(self, instance_id, predicted_proba, suggested_label,
