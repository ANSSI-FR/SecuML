...
from .queries.RareCategoryDetectionQueriesExp import RareCategoryDetectionQueriesExp
from .queries.UncertainQueriesExp import UncertainQueriesExp
...
class IlabExp(Ilab):
    ...
    def setQueries(self):
        ...
        self.uncertain = UncertainQueriesExp(self.iteration,
                                             self.iteration.conf.num_uncertain,
                                             0, 1, label='uncertain')
        self.malicious = RareCategoryDetectionQueriesExp(self.iteration,
                                                         labels_tools.MALICIOUS,
                                                         1 - eps, 1,
                                                         input_checking=False)
        self.benign = RareCategoryDetectionQueriesExp(self.iteration,
                                                      labels_tools.BENIGN,
                                                      0, eps,
                                                      input_checking=False)
