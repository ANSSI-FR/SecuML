...
class LmnnConf(SemiSupervisedProjectionConf):
    ...
    def __init__(self, logger, families_supervision=None):
        SemiSupervisedProjectionConf.__init__(self, logger, Lmnn,
                                    families_supervision=families_supervision)

    @staticmethod
    def from_json(obj, logger):
        conf = LmnnConf(logger,
    ...
    def fromArgs(args, logger):
        return LmnnConf(logger, families_supervision=args.families_supervision)


ProjectionConfFactory.getFactory().registerClass('LmnnConf', LmnnConf)
