...
class Clustering(object):
    ...
    def generateClustering(self, assignment_proba, centroids,
        ...
        for i in range(len(ids)):
            ...
            if centroids is not None:
                ...
                distance = None
            self.clusters[c].addInstance(instance_id, distance, label, family,
                                         annotated)
    ...
    def getClusterInstancesVisu(self, selected_cluster, num_instances,
                                random=False, drop_instances=None):
        cluster = self.clusters[selected_cluster]
        return cluster.getClusterInstancesVisu(num_instances, random,
                                               drop_instances)
