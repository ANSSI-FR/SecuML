...
class Predictions(object):
    ...
    def __init__(self, predictions, all_predicted_proba, predicted_proba,
                 predicted_scores, ids, ground_truth=None):
        ...
        if ground_truth is not None:
            ...
            self.ground_truth = [None for _ in range(self.ids.numInstances())]
        self.checkValidity()
