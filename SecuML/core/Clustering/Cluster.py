...
class Cluster(object):
    ...
    def getClusterInstancesVisu(self, num_instances, rand=False, drop_instances=None):
        ...
        c_e_r = {}
        c_e_r['c'] = self.getClusterInstances(
            'center', num_center, drop_instances=drop_instances)
        c_e_r['e'] = self.getClusterInstances(
            'anomalous', num_edge, drop_instances=drop_instances + c_e_r['c'])
        if rand:
