...
class Instances(object):
    ...
    def __init__(self, ids, features, features_ids, features_names,
                 features_descriptions, labels, families, ground_truth_labels,
                 ground_truth_families, idents=None, timestamps=None):
        self.ids = Ids(ids, idents=idents, timestamps=timestamps)
        self.features = Features(features, features_ids, features_names,
