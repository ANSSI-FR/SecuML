...
from SecuML.core.ActiveLearning.QueryStrategies.AnnotationQueries.Category import Category

from .AnnotationQueryExp import AnnotationQueryExp


class CategoryExp(Category):
