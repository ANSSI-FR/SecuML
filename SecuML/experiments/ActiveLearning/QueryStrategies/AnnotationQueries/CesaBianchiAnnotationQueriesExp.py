...
from SecuML.core.ActiveLearning.QueryStrategies.AnnotationQueries.CesaBianchiAnnotationQueries import CesaBianchiAnnotationQueries

from SecuML.experiments.ActiveLearning.QueryStrategies.AnnotationQueries.AnnotationQueryExp import AnnotationQueryExp


class CesaBianchiAnnotationQueriesExp(CesaBianchiAnnotationQueries):
