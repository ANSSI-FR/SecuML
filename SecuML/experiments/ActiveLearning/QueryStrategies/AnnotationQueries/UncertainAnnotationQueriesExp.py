...
from SecuML.core.ActiveLearning.QueryStrategies.AnnotationQueries.UncertainAnnotationQueries import UncertainAnnotationQueries

from SecuML.experiments.ActiveLearning.QueryStrategies.AnnotationQueries.AnnotationQueryExp import AnnotationQueryExp


class UncertainAnnotationQueriesExp(UncertainAnnotationQueries):
