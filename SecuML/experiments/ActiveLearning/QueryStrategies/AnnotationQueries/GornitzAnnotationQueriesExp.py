...
from SecuML.core.ActiveLearning.QueryStrategies.AnnotationQueries.GornitzAnnotationQueries import GornitzAnnotationQueries


class GornitzAnnotationQueriesExp(GornitzAnnotationQueries):
