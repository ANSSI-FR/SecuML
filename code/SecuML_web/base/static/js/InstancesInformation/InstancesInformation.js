...
function setInstancesSettings(train_test, experiment_id, experiment_label_id, callback) {
    if (train_test == 'validation') {
      ...
      jQuery.getJSON(query, function(data) {
        ...
        inst_exp_label_id = data['test_exp']['oldest_parent'];
      ...
      jQuery.getJSON(query, function(data) {
        if (data['method'] == 'random_split') {
            ...
            inst_exp_id       = experiment_id;
            inst_exp_label_id = getTrueLabelsExperiment(experiment_id);
        } else {
            inst_exp_id       = data['test_exp']['experiment_id'];
            inst_exp_label_id = data['test_exp']['oldest_parent'];
        }
...
function displayUpdateAnnotationForm(form) {
  ...
  ok_button.addEventListener('click', addLabelCallback(experiment_id,
                                                       inst_exp_label_id,
                                                       label_iteration));
  ...
  button.addEventListener('click', removeLabelCallback(
              experiment_id, inst_exp_label_id, label_iteration));
...
function addLabelCallback(experiment_id, inst_exp_label_id, label_iteration) {
  return function() {
...
function removeLabelCallback(experiment_id, inst_exp_label_id, label_iteration) {
  return function() {
    var instance_id = getCurrentInstance();
    var query = buildQuery('removeLabel',
                    [experiment_id,
...
function printWeightedFeatures(selected_id) {
    ...
    var query = buildQuery('getTopWeightedFeatures',
                [experiment_id, inst_exp_id, selected_id, num_coeff]);
    jQuery.getJSON(query, function(data) {
