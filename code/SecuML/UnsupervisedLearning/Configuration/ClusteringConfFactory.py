...
class ClusteringConfFactory():
    ...
    def fromParam(self, class_name, num_clusters, num_results = None, projection_conf = None):
        obj = self.register[class_name + 'Configuration'](num_clusters, num_results = num_results, projection_conf = projection_conf)
        return obj
