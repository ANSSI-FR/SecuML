...
class PredictionsBarplots(object):
    ...
    def display(self, directory):
        ...
        barplot.addDataset(map(len, self.ranges), 'blue', 'numInstances')
        ...
        benign_ranges = map(
                ...
                self.ranges)
        barplot.addDataset(map(len, malicious_ranges), 'red', 'malicious')
        barplot.addDataset(map(len, benign_ranges), 'green', 'benign')
        filename  = directory
