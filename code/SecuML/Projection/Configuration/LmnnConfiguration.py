...
from SecuML.Projection.Algorithms.Lmnn import Lmnn
...
class LmnnConfiguration(SemiSupervisedProjectionConfiguration):
    ...
    def __init__(self, families_supervision = None):
        SemiSupervisedProjectionConfiguration.__init__(self, Lmnn, families_supervision = families_supervision)

    @staticmethod
    def fromJson(obj):
        conf = LmnnConfiguration(families_supervision = obj['families_supervision'])
