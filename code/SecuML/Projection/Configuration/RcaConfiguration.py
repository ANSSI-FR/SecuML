...
from SecuML.Projection.Algorithms.Rca import Rca
...
class RcaConfiguration(SemiSupervisedProjectionConfiguration):
    ...
    def __init__(self, num_components = None, families_supervision = None):
        SemiSupervisedProjectionConfiguration.__init__(self, Rca, num_components = num_components,
...
ProjectionConfFactory.getFactory().registerClass('RcaConfiguration', RcaConfiguration)
