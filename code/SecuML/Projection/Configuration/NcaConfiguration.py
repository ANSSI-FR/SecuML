...
from SecuML.Projection.Algorithms.Nca import Nca
...
class NcaConfiguration(SemiSupervisedProjectionConfiguration):
    ...
    def __init__(self, num_components = None, families_supervision = None):
        SemiSupervisedProjectionConfiguration.__init__(self, Nca, num_components = num_components,
...
ProjectionConfFactory.getFactory().registerClass('NcaConfiguration',
        NcaConfiguration)
