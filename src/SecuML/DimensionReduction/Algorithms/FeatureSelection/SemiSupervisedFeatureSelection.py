...
from SecuML.DimensionReduction.FeatureSelection import FeatureSelection
...
class SemiSupervisedFeatureSelection(FeatureSelection):
    ...
    def getSelectedFeatures(self, features_names):
        non_constant_features = np.array(features_names)[self.var_filter.get_support()]
        selected_features = list(non_constant_features[self.projection.get_support()])
