...
from SecuML.DimensionReduction.Algorithms.FeatureSelection.RecursiveFeatureElimination \
...
class RecursiveFeatureEliminationConfiguration(SemiSupervisedFeatureSelectionConfiguration):
    ...
    def __init__(self, model, step, num_components = None, families_supervision = None):
    ...
    def generateSuffix(self):
        suffix  = SemiSupervisedFeatureSelectionConfiguration.generateSuffix(self)
        suffix += '_step' + str(self.step)
        ## TODO
        #suffix += '_model' + self.model
        return suffix
    ...
    def generateParamsFromArgs(args):
        params = SemiSupervisedFeatureSelectionConfiguration.generateParamsFromArgs(args)
    ...
    def generateParser(parser):
        ...
        parser.add_argument('--model',
                type = str,
                choices = ['LogisticRegression', 'Svc', 'DecisionTree', 'RandomForest'],
